...
public class Oakflesh extends Spell {
	...
	public Oakflesh() {
		super(EnumTier.APPRENTICE, 20, EnumElement.HEALING, "oakflesh", EnumSpellType.DEFENCE, 330, EnumAction.bow, false);
	}

	@Override
	public boolean cast(World world, EntityPlayer caster, int ticksInUse, float damageMultiplier, float rangeMultiplier, float durationMultiplier, float blastMultiplier) {

		caster.addPotionEffect(new PotionEffect(Potion.resistance.id, (int)(300*durationMultiplier), 1, true));
