...
public class Diamondflesh extends Spell {
	...
	public Diamondflesh() {
		super(EnumTier.MASTER, 100, EnumElement.HEALING, "diamondflesh", EnumSpellType.DEFENCE, 450, EnumAction.bow, false);
	}

	@Override
	public boolean cast(World world, EntityPlayer caster, int ticksInUse, float damageMultiplier, float rangeMultiplier, float durationMultiplier, float blastMultiplier) {
		
		caster.addPotionEffect(new PotionEffect(Potion.resistance.id, (int)(150*durationMultiplier), 4, true));
